            ...
            <div class="grid grid-cols-2">
                ...
                <div class="form-group" style="grid-column: span 2;">
                    ...
                    <div class="flex gap-4 mt-2">
                        <label class="form-check" style="flex:1; justify-content:center; padding:1rem; border:2px solid {{ $user->role == 'admin' ? 'var(--kkp-navy)' : 'var(--gray-200)' }}; cursor:pointer;">
                        ...
                        <label class="form-check" style="flex:1; justify-content:center; padding:1rem; border:2px solid {{ $user->role == 'verifikator' ? 'var(--kkp-teal)' : 'var(--gray-200)' }}; cursor:pointer;">
