        ...
        <div class="section-body">
            <div class="grid grid-cols-2">
                <div class="form-group" style="grid-column: span 2;">
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" required class="form-control" placeholder="Masukkan username">
                ...
                <div class="form-group" style="grid-column: span 2;">
                    ...
                    <div class="flex gap-4 mt-2">
                        <label class="form-check" style="flex:1; justify-content:center; padding:1rem; border:2px solid var(--gray-200); cursor:pointer;">
                            <input type="radio" name="role" value="admin" {{ old('role') == 'admin' ? 'checked' : '' }} required class="form-check-input">
                        ...
                        <label class="form-check" style="flex:1; justify-content:center; padding:1rem; border:2px solid var(--gray-200); cursor:pointer;">
                            <input type="radio" name="role" value="verifikator" {{ old('role', 'verifikator') == 'verifikator' ? 'checked' : '' }} class="form-check-input">
                            <div style="text-align:center;">
